<?php
    ...
    register_nav_menus(
        array(
            ...
            'categories-filter-menu' => __('Categories Filter Menu', 'theme'),
        )
    );

    add_theme_support('post-thumbnails');

    /*<!-- هذ التصميم لعرض صفحة قائمة بوستات يعني لعرض اللوحات الموجودة مثلا في سنة bootstrap + style  او اللوحات الموجودة في سنة 2015 -->*/